    ...
    return (
        <section className='container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8'>
            ...
            <div className='w-full md:w:1/2 space-y-8'>
                ...
                <h1 className='text-4xl md:text-5xl  font-bold leading-tight'>We boost the growth for <span className='text-blue-600 relative inline-block '>Startup to Fortune 500 <span className='absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60'></span>
                    </span> 
